...
public class SonicJavaScriptInterface {
    private static final String TAG = "SonicJavaScriptInter";
    ...
    public void getDiffData2(final String jsCallbackFunc) {
        LogUtil.i(TAG, "getDiffData2");
        if (null != sessionClient) {
            sessionClient.getDiffData(resultData -> {
                Runnable callbackRunnable = () -> {
                    String jsCode =
                            "javascript:" + jsCallbackFunc + "('" + toJsString(resultData) + "')";
    ...
    public String getPerformance() {
        ...
        try {
            ...
            LogUtil.i(TAG, "getPerformance: ");
            return result.toString();
        } catch (Exception e) {
            LogUtil.e(TAG, "getPerformance: ", e);
        }
        return "";
    }
