...
public class PersistentCookieStore implements CookieStore {
    ...
    private String hostName(HttpUrl httpUrl) {
        return httpUrl.host().startsWith(HOST_NAME_PREFIX) ? httpUrl
                .host() : HOST_NAME_PREFIX + httpUrl.host();
    }
    ...
    protected String encodeCookie(SerializableCookie cookie) {
        ...
        try {
            ...
            LogUtil.d(TAG, "IOException in encodeCookie", e);
            return null;
        }
    ...
    protected Cookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            LogUtil.d(TAG, "IOException in decodeCookie", e);
        } catch (ClassNotFoundException e) {
            LogUtil.d(TAG, "ClassNotFoundException in decodeCookie", e);
        }
        return cookie;
    }
